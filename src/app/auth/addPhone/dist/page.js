...
var Page = function () {
    var _a = react_2.useState(''), phone = _a[0], setPhone = _a[1];
    console.log(phone);
    var _b = react_2.useState('+91'), phone = _b[0], setPhone = _b[1];
    var _c = react_2.useState(''), isError = _c[0], setIsError = _c[1];
    setIsError('');
    ...
    var sendVerificationCode = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios.post('/api/authOTP/', { phoneNumber: phone })];
                case 1:
                    response = _a.sent();
