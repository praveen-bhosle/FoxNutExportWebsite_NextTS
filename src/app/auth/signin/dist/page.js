...
var Page = function () {
    ...
    var _m = react_1.useState(''), otpPhone = _m[0], setOtpPhone = _m[1];
    var _o = react_1.useState(''), otpEmail = _o[0], setOtpEmail = _o[1];
    setOtpPhoneState('');
    ...
    var _p = react_1.useState(''), isError = _p[0], setIsError = _p[1];
    setIsError('');
    return (React.createElement(React.Fragment, null,
        " ",
        React.createElement("div", { className: '' },
            React.createElement("div", { className: 'flex justify-center items-center  h-[90vh] mx-[5%] ' },
                React.createElement("div", { className: ' rounded-xl p-2  bg-[#E9EAF2] flex flex-col gap-16 justify-between  ' },
                    React.createElement("div", { className: '' },
                        React.createElement("div", { className: 'text-2xl font-semibold text-black text-center' },
                            "Welcome to ",
                            React.createElement("span", { className: 'text-[#3F6EEA]' }, "YKDevoutExports")),
                        React.createElement("div", { className: 'text-xs font-bold text-center ' }, "Login to get exclusive products and services!")),
                    React.createElement("div", null, stage === 1 ?
                        React.createElement("div", { className: 'flex flex-col gap-2' },
                            React.createElement("div", { className: ' text-white  px-4 py-2 rounded-md w-full bg-[#5826EB]  text-sm text-center font-bold cursor-pointer ', onClick: function () { setMode('email'); setStage(2); } }, " Log in with email "),
                            React.createElement("div", { className: ' text-white  px-4 py-2 rounded-md w-full bg-[#5826EB]  text-sm text-center font-bold cursor-pointer ', onClick: function () { setMode('phone'); setStage(2); } }, " Log in with phone  "))
                        : stage === 2 ?
                            React.createElement("div", { className: 'flex flex-col gap-2' },
                                React.createElement("div", { className: ' text-white  px-4 py-2 rounded-md w-full bg-[#5826EB]  text-sm text-center font-bold cursor-pointer ', onClick: function () { setType_('password'); setStage(3); } }, " Log in using password "),
                                React.createElement("div", { className: ' text-white  px-4 py-2 rounded-md w-full bg-[#5826EB]  text-sm text-center font-bold cursor-pointer ', onClick: function () { setType_('otp'); setStage(3); } }, " Log in with  OTP      "),
                                React.createElement("div", { className: ' text-white  px-4 py-2 rounded-md w-full bg-[#5826EB]  text-sm text-center font-bold cursor-pointer ', onClick: function () { setStage(1); } }, " Go back      "))
                            : type_ === 'password' && mode === 'email' ? React.createElement("div", { className: 'flex flex-col gap-2' },
                                ...
                                React.createElement("div", { className: ' text-white  px-4 py-2 rounded-md w-full bg-[#5826EB] hover:bg-[#6581EC] text-sm text-center font-bold cursor-pointer', onClick: function () { return checkPasswordWithEmail; } }, "Log in"),
                                React.createElement("div", { className: ' text-white  px-4 py-2 rounded-md w-full bg-[#5826EB]  text-sm text-center font-bold cursor-pointer ', onClick: function () { setStage(2); } }, " Go back      "))
                                : type_ === 'password' && mode === 'phone' ? React.createElement("div", { className: 'flex flex-col gap-2' },
                                    ...
                                    type_ === 'otp' && mode === 'email' ?
                                        React.createElement("div", { className: 'flex flex-col gap-2' },
                                            React.createElement("label", { className: 'block  text-xs text-black mb-[2px]', htmlFor: 'email' }, " Email   "),
                                            React.createElement("input", { type: 'text', placeholder: '', value: email, onChange: function (e) {
                                                    setEmail(e.target.value);
                                                }, className: 'p-2 outline-none text-xs rounded-md bg-[#DDDEE7] text-black w-full', id: 'email' }),
                                            React.createElement("div", { className: ' text-white  px-4 py-2 rounded-md w-full bg-[#5826EB] hover:bg-[#6581EC] text-sm text-center font-bold cursor-pointer', onClick: function () { return sendOtpToEmail; } }, " Send OTP "),
                                            React.createElement("div", { className: ' text-white  px-4 py-2 rounded-md w-full bg-[#5826EB]  text-sm text-center font-bold cursor-pointer ', onClick: function () { setStage(2); } }, " Go back      ")) :
                                        React.createElement("div", { className: 'flex flex-col gap-2' },
                                            React.createElement("label", { className: 'block  text-xs text-black mb-[2px]', htmlFor: 'phone' }, "Phone  "),
                                            React.createElement("input", { type: 'text', placeholder: '', value: phone, onChange: function (e) {
                                            ...
                                            React.createElement("div", { className: ' text-white  px-4 py-2 rounded-md w-full bg-[#5826EB] hover:bg-[#6581EC] text-sm text-center font-bold cursor-pointer', onClick: function () { return sendOtpToPhone; } }, " Send OTP "),
                                            React.createElement("div", { className: ' text-white  px-4 py-2 rounded-md w-full bg-[#5826EB]  text-sm text-center font-bold cursor-pointer ', onClick: function () { setStage(2); } }, " Go back      "))))),
            isError &&
