...
var Page = function () {
    ...
    var googleLoginSuccess = function () { return __awaiter(void 0, void 0, void 0, function () {
        var res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1["default"].get('https://www.googleapis.com/oauth2/v1/userinfo').then()];
                case 1:
                    res = _a.sent();
    ...
    var googleLoginFailed = function () {
        setIsError('Failed to log in');
    };
    var googleLoginClicked = function () { };
    if (mode === 'email' && globalState !== 'signedUp') {
        return (react_1["default"].createElement("div", { className: '' },
            react_1["default"].createElement("div", { className: 'flex justify-center items-center  h-[90vh] mx-[5%] ' },
                react_1["default"].createElement("div", { className: ' rounded-xl p-2  bg-[#E9EAF2] flex flex-col gap-16 justify-between  ' },
                    react_1["default"].createElement("div", { className: '' },
                        react_1["default"].createElement("div", { className: 'text-2xl font-semibold text-black text-center cursor-pointer ', onClick: function () { return router.replace('/new'); } }, "Welcome to YKDevoutExports"),
                    ...
                    globalState === 'initial' ? react_1["default"].createElement(react_1["default"].Fragment, null,
                        react_1["default"].createElement("div", { className: 'mx-4 mb-4 text-black ' },
                            ...
                            react_1["default"].createElement("button", { onClick: function () { return __awaiter(void 0, void 0, void 0, function () {
                                    ...
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            ...
                                            case 1:
                                                ...
                                                return [4 /*yield*/, axios_1["default"].post('/api/auth/sendOTP/', body)];
                                            case 2:
                                                res = _a.sent();
                                                console.log(res);
                                                resBody = res.data;
                                ...
                                }); }, style: { backgroundColor: email.includes('@') ? '#5826EB' : '#95A2ED' }, className: '   text-white  px-4 py-2 rounded-md w-full  text-xs' },
                                ' ',
                                "Get verification code",
                                ' ')),
                        react_1["default"].createElement(link_1["default"], { className: '  bg-[#5826EB] w-full text-white py-2 px-4 text-sm rounded-md text-center font-bold  cursor-pointer opacity-0', href: '/' }, "    Sign up with phone instead     "),
                        react_1["default"].createElement(google_1.GoogleLogin, { onSuccess: googleLoginSuccess, onError: googleLoginFailed, click_listener: googleLoginClicked }))
                        : globalState === 'loading' ?
                            react_1["default"].createElement(react_1["default"].Fragment, null,
                                react_1["default"].createElement("div", { className: 'text-center' },
                                    "  ",
                                    react_1["default"].createElement("div", { className: 'text-2xl font-bold' }, " Loading...  "),
                                    " "),
                                            ...
                                            react_1["default"].createElement("div", { className: ' text-center mt-4 bg-black  w-[40%] text-white font-bold  rounded-[20px] border-2 cursor-pointer py-[4px] select-none ', onClick: function () { return __awaiter(void 0, void 0, void 0, function () {
                                                    ...
                                                    return __generator(this, function (_a) {
                                                        switch (_a.label) {
                                                            case 0:
                                                                setGlobalState('loading');
                                                                return [4 /*yield*/, axios_1["default"].post('/api/auth/checkOTP/', { OTP: OTP_, otpId: otpId, email: email }).then(function (res) { return res.data; })];
                                                            case 1:
                                                                response = _a.sent();
        ...
        return (react_1["default"].createElement("div", { className: '' },
                                            ...
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
                                                    case 0:
                                                        ...
                                                        return [4 /*yield*/, axios_1["default"].post("/api/auth/setPassword", { email: email, password: password }).then(function (response) { return response.data; })];
                                                    case 1:
                                                        res = _a.sent();
                                                        if (res.success) {
                                                            setFinalState('final');
            ...
            isError &&
                (react_1["default"].createElement("div", { className: 'w-[50%] p-2 rounded-md bg-red-500 my-2  text-white mx-[25%]' }, JSON.stringify(isError)))));
    }
};
