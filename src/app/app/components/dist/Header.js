...
var Header = function () {
    ...
    return (react_1["default"].createElement("div", { className: 'border  w-full fixed  bg-white  top-[0px] left-[0px] ' },
        react_1["default"].createElement("div", { className: 'flex justify-between mb-2  align-center mx-4 mt-[9px] h-[30px]     ' },
            ...
            react_1["default"].createElement("div", { className: 'relative bottom-[4px]' },
                react_1["default"].createElement(link_1["default"], { href: "/" },
                    react_1["default"].createElement(image_1["default"], { src: '/logp.jpeg', alt: 'logo', width: 40, height: 40 }))),
        ...
        isOpen && (react_1["default"].createElement("div", { className: 'm-2' },
            ...
            react_1["default"].createElement(link_1["default"], { className: 'block w-[90vw] px-2 py-1 hover:bg-custom-hover text-custom-subheading my-2  rounded-md', href: '' }, "My orders"),
            react_1["default"].createElement(link_1["default"], { className: 'block w-[90vw] px-2 py-1 hover:bg-custom-hover text-custom-subheading my-2  rounded-md', href: '' }, "My addresses"))),
