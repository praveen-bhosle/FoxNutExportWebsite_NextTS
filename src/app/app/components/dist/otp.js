        ...
        container &&
            react_1["default"].createElement("div", { className: 'bg-white absolute  p-[2px]  rounded-md bg-blue-50  w-[280px]  ' },
                react_1["default"].createElement("div", { className: 'flex gap-1 mt-[3px] mb-2' },
                    ...
                    filter ? react_1["default"].createElement(image_1["default"], { width: 10, height: 10, alt: 'close', src: '/close.svg', onClick: function (e) { setFilter(''); } }) : react_1["default"].createElement(image_1["default"], { width: 10, height: 10, alt: 'close', src: '/close.svg', className: 'opacity-0' })),
                react_1["default"].createElement("div", { className: 'h-[150px] overflow-y-scroll px-2' }, countryCodes_1.countryCodes.map(function (element) {
                    if (element[0].toLowerCase().includes(filter.toLowerCase())) {
                        return (react_1["default"].createElement("div", { className: 'flex justify-between py-2 hover:bg-[#F0F2F5] rounded-md px-2  text-sm select-none', onClick: function () {
