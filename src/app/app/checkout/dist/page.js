                ...
                react_1["default"].createElement("div", null,
                    react_1["default"].createElement("div", null,
                        ...
                        react_1["default"].createElement("div", { className: 'flex justify-between my-2' },
                            ...
                            "   ",
                            react_1["default"].createElement("input", { type: 'text', required: true, id: 'address', name: 'address', className: 'text-sm px-2 outline-none  border-2 border-black', value: addressObject.address ? addressObject.address : '', onChange: function (e) {
                        ...
                        react_1["default"].createElement("div", { className: 'flex justify-between my-2' },
                            ...
                            "        ",
                            react_1["default"].createElement("input", { type: 'text', required: true, id: 'city', name: 'city', className: 'text-sm px-2 outline-none border-2 border-black', value: addressObject.city ? addressObject.city : '', onChange: function (e) {
                        ...
                        react_1["default"].createElement("div", { className: 'flex justify-between my-2' },
                            ...
                            "    ",
                            react_1["default"].createElement("input", { type: 'text', required: true, id: 'state', name: 'state', className: 'text-sm px-2 outline-none border-2 border-black', value: addressObject.state ? addressObject.state : '', onChange: function (e) {
                        ...
                        react_1["default"].createElement("div", { className: 'flex justify-between my-2' },
                            ...
                            "  ",
                            react_1["default"].createElement("input", { type: 'text', required: true, id: 'country', name: 'country', className: 'text-sm px-2 outline-none border-2 border-black', value: addressObject.country ? addressObject.country : '', onChange: function (e) {
                        ...
                        react_1["default"].createElement("div", { className: 'flex justify-between my-2' },
                            ...
                            "  ",
                            react_1["default"].createElement("input", { type: 'text', required: true, id: 'pin', name: 'pin', className: 'text-sm px-2 outline-none border-2 border-black', value: addressObject.zipcode ? addressObject.zipcode : '', onChange: function (e) {
